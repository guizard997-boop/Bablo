...
# ==================== TELEGRAM BOT ====================
# --- Настройки бота (можно переопределить через Variables в Railway) ---
...
OPENAI_KEY = os.environ.get('OPENAI_API_KEY', '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')
DEFAULT_SITE = 'https://mircancelyarii-production.up.railway.app'
